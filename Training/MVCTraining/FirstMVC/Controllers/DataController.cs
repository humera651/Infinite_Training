...
namespace FirstMVC.Controllers
{
    public class DataController : Controller
    {
        ...
        public ActionResult ColoursData()
        {
            //1. passing an object to the view that will b used as a model
            ViewBag.data = "Colours List";
            List<string> colourslst = new List<string>
            {
                "Red", "Pink","Blue","Violet"
            };

            TempData["colours"] = colourslst;
            //redirecting to see termpdata values in sifferent controller
            return RedirectToAction("TestColoursRedirect", "Demo");
        }
    }
}