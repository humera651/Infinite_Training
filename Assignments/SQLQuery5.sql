...
declare @sourceacc int = 201
declare @targetacc int = 101
...
values (501,601, getdate(), 'sample 1', 100, 1);
save transaction s1;
insert into orders (custid, orderid, orderdate, product, price, quantity)
values (502,602, getdate(), 'sample 2', 200, 2);
save transaction s2;
insert into orders (custid, orderid, orderdate, product, price, quantity)
values (503,603, getdate(), 'sample 3', 300, 3);
save transaction s3;
...
select * from customers where custid = 103
...
values (206, 'monitor', 50, 'electronics', 55000)
insert into products (pid, pname, stock, categoryname, price)
values (205, 'mouse', 200, 'electronics', 500);
insert into products (pid, pname, stock, categoryname, price)
values (202, 'cpu', 100, 'electronics', 1500);
...
insert into orders (custid, orderid, orderdate, product, price, quantity)
values (201, 104, getdate(), 'bag', 500, 1)
save transaction s1

insert into orders (custid, orderid, orderdate, product, price, quantity)
values (202, 105, getdate(), 'keyboard', 800, 2)
save transaction s2

select 10 / 0  

insert into orders (custid, orderid, orderdate, product, price, quantity)
values (203, 103, getdate(), 'mouse', 300, 1)
save transaction s3
